...
// Generated for xiAPI version 4.17.24
...
typedef enum
{
	XI_PE_ALL                    =0, // Use all available instrunctions
	XI_PE_C                      =1, // Use C(C++) code
	XI_PE_SSE2                   =3, // Use SSE2 instrunctions
	XI_PE_AVX                    =4, // Use AVX instrunctions
	XI_PE_AVX2                   =5, // Use AVX2 instrunctions
...
public:
	...
	int GetTimestamp();
	int GetTimestamp_Maximum();
	int GetTimestamp_Minimum();
	int GetTimestamp_Increment();
	...
	XI_DP_PROC_UNIT_SELECTOR GetDataPipeUnitSelector();
	XI_DP_PROC_UNIT_SELECTOR GetDataPipeUnitSelector_Maximum();
	XI_DP_PROC_UNIT_SELECTOR GetDataPipeUnitSelector_Minimum();
	int GetDataPipeUnitSelector_Increment();
	
	void SetDataPipeUnitSelector(XI_DP_PROC_UNIT_SELECTOR DataPipeUnitSelector);
