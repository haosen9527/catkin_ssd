...
int main() {
  ...
  String prototxt = "ssd_inception_v2_coco_2017_11_17.pbtxt";
  dnn::Net net = cv::dnn::readNetFromTensorflow(weights,prototxt); //readNetFromTensorflow(weights, prototxt);
